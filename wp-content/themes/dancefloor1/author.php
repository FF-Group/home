...
<?php if ( get_option('layout') == 'right_sidebar'  ) echo '<div id="content" style="float:left;margin-left:22px;">'; else echo '<div  id="content" style="float:right;margin-right:42px;">';?> 
	...
	<div class="postcom">
	  <p class="taghead"><?php _e("Articles by ","language"); ?>  <?php echo $curauth->first_name; ?> <?php echo $curauth->last_name; ?></p>
...
the_excerpt();
} else { echo'<a href="'.get_permalink().'">'.category_image($post->ID,'medium').'</a>';
the_excerpt();  } ?>	
